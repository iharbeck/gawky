	...
	public StringBuilder generateInsertSQL(Table bean)
	{
		...
		if(bean.getDescIDs()[0] != null) // descid != null)
		{
			if(bean.getIdgenerator() != null && bean.getIdgenerator().getSequence() != null) { 
			    ...
			    sql.append(",").append(bean.getDescIDs()[0].dbname);
			    params.append(",").append(bean.getIdgenerator().getSequence()); // generate Methode einfügen
			    ...
			    {
					sql.append(",").append(descids[i].dbname);
