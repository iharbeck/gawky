...
//	 Record definition
	public Desc[] getDesc() 
	{
		return new Desc[] {
			...
			new DescV(Desc.FMT_A, Desc.CODE_O, 4,  "identity_score", Desc.END01),
			new DescV(Desc.FMT_A, Desc.CODE_O, 4,  "micro_geographic_score", Desc.END01),
			new DescV(Desc.FMT_A, Desc.CODE_O, 100,"redirect_url", Desc.END01)
		}; 
	}
