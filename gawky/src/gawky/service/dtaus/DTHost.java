...
public class DTHost
{
	...
	public static void read(File f, DTProcessorHost processor) throws IOException, Exception
    {
		DTHost handler = new DTHost();
    ...
    public static void write(File f, DTProcessorHost processor) throws IOException, Exception
    {
    ...
    {
    	DTProcessorHost processor = new DTProcessorHost();
