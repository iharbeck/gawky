...
public class SatzC extends Part 
{
    public Desc[] getDesc() 
	{
		return new Desc[] {
			...
			new DescC("C"),
			new DescF(Desc.FMT_9, Desc.CODE_R, 5,   "blzerstbeteiligt"),          
			new DescF(Desc.FMT_A, Desc.CODE_R, 5,   "blzkontofuehrend"),          
			new DescF(Desc.FMT_A, Desc.CODE_R, 6,   "kontonummer"),          
			new DescF(Desc.FMT_A, Desc.CODE_R, 6,   "referenznummer"),
			new DescF(Desc.FMT_A, Desc.CODE_R, 7,   "bankintern"),
			new DescF(Desc.FMT_A, Desc.CODE_R, 1,   "textschluessel"),
			new DescF(Desc.FMT_A, Desc.CODE_R, 2,   "textschluesselergaenzung"),
			new Reserved(1),
			new DescF(Desc.FMT_A, Desc.CODE_R, 11,  "betragdm"),
			new DescF(Desc.FMT_A, Desc.CODE_R, 5,   "blzauftraggeber"),
			new DescF(Desc.FMT_A, Desc.CODE_R, 6,   "kontonummerauftraggeber"),
