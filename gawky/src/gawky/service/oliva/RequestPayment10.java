...
//	 Record definition
	public Desc[] getDesc() 
	{
		return new Desc[] {
		    ...
		    new DescF(Desc.FMT_A, Desc.CODE_R, 1, "creditdebit"),
		    new DescF(Desc.FMT_A, Desc.CODE_R, 1, "encr"),
		    new DescF(Desc.FMT_A, Desc.CODE_R, 1, "debitorcreditor"),
		    ...
		    new DescF(Desc.FMT_A, Desc.CODE_R, 0, "paymentdetails")
		}; 
	}
	
	
	private String creditdebit       = " ";  // default
	private String encr       		 = "0";  // default
	private String debitorcreditor   = " ";  // default
	private String holdername        = "";  // default

	
	// Extentions for PAYM10
    String TH01_reference_number   = "";
    String TH00_cv2				   = "";
    String TH00_auth_value		   = "";
	
	
	 //Payment part_02 (type_of_handling)
    ...
    String TH02_order_date;
	 ...
	 //Payment part_04 (type_of_handling)
    String TH04_IBAN;
    String TH04_BIC;
    String TH04_reference_number;

    //  type of handling (PAYM)
    final static String TOH_BIC  = "04";
    ...
    public String getPaymentdetails()
    {
        ...
        else if(TOH_BIC.equals(type_of_handling)) // 04 direct debit
        {
